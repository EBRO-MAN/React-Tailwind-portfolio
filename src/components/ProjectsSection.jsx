...
const projects =[
    {
        id: 1,
        title: "Sheep Breeding Expert System",
...
export const ProjectsSection = () => {
    ...
    className="py-24 px-4 relative">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
            ...
            Each project highlights my ability to create functional and visually appealing web applications.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project,key) => (
                ...
                <h3 className="text-xl font-semibold mb-21">{project.title}</h3>
        ...
        <div className="text-center mt-12">
            <a href="https://github.com/EBRO-MAN"
            target="_blank"
